...
export default class ReportController {
  static async getIncidentsRange(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getIncidentsRange(
        startDate,
        endDate
      );
  ...
  static async getAllIncidentsYear(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getIncidentsYear(
        currentYear
      );
      return res.status(status).json(incidents);
    } catch (error) {
  ...
  static async getTotalIncYears(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getTotalIncYears(
        lastYear
      );
      return res.status(status).json(incidents);
    } catch (error) {
  ...
  static async getOpenIncidentsGroup(req, res, next) {
    try {
      const { status, incidents } =
        await IncidentsService.getOpenIncidentsGroup();
      return res.status(status).json(incidents);
    } catch (error) {
      next(error);
    }
  ...
  static async getAllIncidentsGroup(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getAllIncidentsGroup(
        startDate,
        endDate
      );
      return res.status(status).json(incidents);
  ...
  static async getAllIncLocationRange(req, res, next) {
    ...
    try {
      const { status, incidents } =
        await IncidentsService.getAllIncLocationRange(startDate, endDate);
      return res.status(status).json(incidents);
    } catch (error) {
      next(error);
    }
  ...
  static async getAllIncBasesRange(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getAllIncBasesRange(
        startDate,
        endDate
      );
      return res.status(status).json(incidents);
  ...
  static async getAllIncParkingRange(req, res, next) {
    ...
    try {
      const { status, incidents } =
        await IncidentsService.getAllIncParkingRange(startDate, endDate);
      return res.status(status).json(incidents);
    } catch (error) {
      next(error);
    }
  ...
  static async getAllIncByHours(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getAllIncByHours(
        startDate,
        endDate
      );
      return res.status(status).json(incidents);
  ...
  static async getAllIncByWeekdays(req, res, next) {
    ...
    try {
      const { status, incidents } = await IncidentsService.getAllIncByWeekdays(
        startDate,
        endDate
      );
      return res.status(status).json(incidents);
